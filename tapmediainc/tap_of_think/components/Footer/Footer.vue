                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <div class="footer-items">
                            ...
                            <p class="text-white-50 mt-2 mb-3">TAP is a corporation specializing in online newspaper and social media platforms.</p>
                            <p class="text-white-50 mt-2 mb-3">For more information, please contact: contact@tapofthink.com</p>
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        ...
                        <div class="footer-items">
                            ...
                            <ul>
                                ...
                                <li class="py-2"><a class="text-white-50" href="/about">About Us</a></li>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="copyright-area d-flex flex-wrap justify-content-center justify-content-sm-between text-center py-4">
                            <!-- Copyright Left -->
                            <div class="copyright-left text-white-50">&copy; Copyright © 2021 - 2024 - TAP of Think.</div>
                            <!-- Copyright Right -->
