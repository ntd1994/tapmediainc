                          ...
                          <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu mega-menu blog-menu px-3 py-md-3">
                              <div class="row">
                                <div class="col-12">
                                  <ul class="single-menu">
                                    <li><a class="dropdown-item" href="/support/backup">Backup</a></li>
                                    <li><a class="dropdown-item" href="/support/pin-yoush">Pin Yoush</a></li>
                                    <li><a class="dropdown-item" href="/support/yoush-profiles-and-message-requests">Yoush Profiles and Message Requests</a></li>
                                    <li><a class="dropdown-item" href="/support/safety-number">Safety Number</a></li>
                                    <li><a class="dropdown-item" href="/support/debug-logs-and-crash-reports">Debug Logs and Crash Reports</a></li>
                                    <li><a class="dropdown-item" href="/support/incognito-keyboard">Incognito Keyboard</a></li>
                                    <li><a class="dropdown-item" href="/support/proxy-support">Proxy Support</a></li>
                                    <li><a class="dropdown-item" href="/support/sealed-sender">Sealed Sender</a></li>
                                    <li><a class="dropdown-item" href="/support/delivery-issue">Delivery Issue</a></li>
                                    <li><a class="dropdown-item" href="/support/group-chats">Group chats</a></li>
                                    <li><a class="dropdown-item" href="/support/troubleshooting-multiple-devices">Troubleshooting multiple devices</a></li>
                                    <li><a class="dropdown-item" href="/support/can-i-send-sms-mms-with-yoush">Can I send SMS/MMS with Yoush?</a></li>
                                    <li><a class="dropdown-item" href="/support/group">Group</a></li>
                                  </ul>
                                </div>
                              </div>
                            </div>
