                        ...
                        <article class="single-blog-details">
                            ...
                            <div class="blog-content appo-blog">
                                ...
                                <div class="blog-details">
                                    <h3 class="blog-title py-2 py-sm-3"><a href="#">Promote your product to a new level with Appo</a></h3>
                                    ...
                                    <blockquote class="blockquote px-4 py-3 my-3 ml-4">
                                        <p class="d-none d-sm-block">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime magnam, molestias omnis quam veritatis consectetur nihil aliquid quo culpa? Ullam molestiae id temporibus nemo inventore, at reiciendis distinctio porro atque!</p>
                                        <p class="d-block d-sm-none">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aspernatur ullam dolor, omnis maiores molestiae ducimus.</p>
                                    </blockquote>
                                    <p class="d-none d-sm-block">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique placeat deleniti repellat alias maiores corrupti, commodi rem eum molestiae distinctio vitae perferendis at esse ex quas hic quis debitis quasi aspernatur incidunt, excepturi sapiente ducimus nisi. Ad molestiae, blanditiis ducimus.</p>
                                    <p class="d-block d-sm-none">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est mollitia, tenetur libero voluptate quisquam consectetur facilis natus molestiae officiis aperiam.</p>
                                </div>
                                                ...
                                                <li>
                                                    <a href="#" class="single-post align-items-center align-items-lg-start media p-3">
                                                        ...
                                                        <div class="post-content media-body pl-3">
                                                            ...
                                                            <h6>Promote Your Apps With Appo</h6>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="single-accordion blog-accordion">
                                        ...
                                        <div id="accordion3" class="accordion-content widget-content collapse show" data-parent="#tags-accordion">
                                            ...
                                            <div class="widget-content tags-widget-items pt-2">
                                                <a href="#" class="d-inline-block mt-2 mr-1 px-2 py-1">Appo</a>
...
import HeaderSection from '../../Header/HeaderTwo'
import BreadcrumbSection from '../../Breadcrumb/BlogDetailsRightSidebar/BlogDetailsRightSidebar'
